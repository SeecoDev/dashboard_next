...
function FormPerron({ sendResults }) {
  ...
  const handleSubmit = (e) => {
    ...
    const results = {
      ...
      residualMassPercentage: residualMassPercentage,
      fatWeight: fatWeight,
    ...
    <div className=" flex-row pt-4 pb-4 w-full max-w-lg">
      <form onSubmit={handleSubmit}>
        ...
        <div className="pb-2">
          ...
          <InputComponent
            label="Supralaico (mm)"
            placeholder="Supralaico"
            name="supralaic"
            type="number"
            value={inputValues.supralaic}
            onChange={handleInputChange}
          />
        </div>
        <div className="pb-2">
          <hr></hr>
          <InputComponent
            label="Biestoloideo (cm)"
            placeholder="Biestoloideo"
            name="bistoloid"
            type="number"
            value={inputValues.bistoloid}
            onChange={handleInputChange}
          />
          <InputComponent
            label="Femur (cm)"
